...
public class Screen37_Model {
    Integer imgpicgiral;
    Integer profileimage;
    String tv1,tv2,tv3,tv4,tv5,tv6,tv7;

    public Integer getImgpicgiral() {
        return imgpicgiral;
    }

    public void setImgpicgiral(Integer imgpicgiral) {
        this.imgpicgiral = imgpicgiral;
    }
    ...
    public Screen37_Model(Integer imgpicgiral, Integer profileimage, String tv1, String tv2, String tv3, String tv4,
                          String tv5, String tv6, String tv7) {
        this.imgpicgiral = imgpicgiral;
        this.profileimage = profileimage;
        this.tv1 = tv1;
        this.tv2 = tv2;
